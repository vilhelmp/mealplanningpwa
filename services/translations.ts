...
export const BASE_TRANSLATIONS = {
  [Language.EN]: {
    ...
    datePassed: "Date passed, no meal",
    addMeal: "Add Meal",
    ...
    ingredientsFilter: "Contains Ingredient",
    ...
    carbSources: "Carbohydrate Sources",
    meals: "meals",
    oneIn: "Roughly 1 in",
  ...
  [Language.SV]: {
    ...
    datePassed: "Datumet passerat, ingen måltid",
    addMeal: "Lägg till",
    ...
    // Filters
    filter: "Filtrera",
    activeFilters: "aktiva",
    clearAll: "Rensa alla",
    spicyOnly: "Endast starkt",
    minRating: "Minsta betyg",
    ingredientsFilter: "Innehåller ingrediens",
    cuisineFilter: "Kök",
    ...
    calcNutrition: "Uppskatta",
    reEstimate: "Uppdatera",
